...
const GAME_ICONS_BASE = 'https://cdn.jsdelivr.net/gh/game-icons/icons@master'

export const UPGRADE_ICON_URL: Record<UpgradeType, string> = {
  armor: `${GAME_ICONS_BASE}/sbed/shield.svg`,
  damage: `${GAME_ICONS_BASE}/lorc/crossed-swords.svg`,
  fireRate: `${GAME_ICONS_BASE}/lorc/lightning-arc.svg`,
  moveSpeed: `${GAME_ICONS_BASE}/lorc/sprint.svg`,
  bulletSpeed: `${GAME_ICONS_BASE}/lorc/striking-arrows.svg`,
  critChance: `${GAME_ICONS_BASE}/delapouite/eye-target.svg`,
  critDamage: `${GAME_ICONS_BASE}/lorc/explosion-rays.svg`,
  scoreBonus: `${GAME_ICONS_BASE}/lorc/gem-pendant.svg`,
  doubleShot: `${GAME_ICONS_BASE}/lorc/three-burning-balls.svg`,
  tripleShot: `${GAME_ICONS_BASE}/lorc/triple-shells.svg`,
  xpBoost: `${GAME_ICONS_BASE}/lorc/striking-balls.svg`,
  piercingShell: `${GAME_ICONS_BASE}/lorc/spear-hook.svg`,
  explosiveShell: `${GAME_ICONS_BASE}/lorc/grenade.svg`,
  pickupRadius: `${GAME_ICONS_BASE}/lorc/magnet.svg`,
  bossDamage: `${GAME_ICONS_BASE}/lorc/crowned-skull.svg`,
  bulletGirth: `${GAME_ICONS_BASE}/lorc/cannon-shot.svg`,
  vampireBite: `${GAME_ICONS_BASE}/lorc/snake-bite.svg`,
  ricochet: `${GAME_ICONS_BASE}/lorc/return-arrow.svg`,
  adrenalineRush: `${GAME_ICONS_BASE}/lorc/syringe.svg`,
  berserker: `${GAME_ICONS_BASE}/lorc/wolf-howl.svg`,
  phaseShift: `${GAME_ICONS_BASE}/lorc/ghost.svg`,
  omegaShell: `${GAME_ICONS_BASE}/lorc/omega.svg`,
  healPack: `${GAME_ICONS_BASE}/lorc/bandage-roll.svg`,
  shieldBoost: `${GAME_ICONS_BASE}/lorc/checked-shield.svg`,
  goldRush: `${GAME_ICONS_BASE}/delapouite/two-coins.svg`,
}

export const RARITY_HUE_FILTER: Record<UpgradeRarity, string> = {
  common: 'grayscale(1) brightness(1.3) contrast(1.1)',
  uncommon: '',
  rare: 'hue-rotate(180deg) saturate(1.1)',
  epic: 'hue-rotate(220deg) saturate(1.4) brightness(1.05)',
  legendary: 'hue-rotate(50deg) saturate(1.6) brightness(1.1)',
  mythic: 'hue-rotate(320deg) saturate(2.2) brightness(1.05)',
}

export const UPGRADE_GLYPHS: Record<UpgradeType, string> = {
  armor: '⛨',
  damage: '⚔',
  fireRate: '⚡',
  moveSpeed: '➤',
